/**
 * Supervision Services - Application Layer Export
 *
...
/**
 * Supervision Services - Application Layer
 *
 * DDD: Application use cases, ports, DTOs, policies, and errors for supervision domain.
 */
