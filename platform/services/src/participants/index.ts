/**
 * Participants Services - Application Layer Export
 *
...
/**
 * Participants Services - Application Layer
 *
 * DDD: Application use cases, ports, DTOs, policies, and errors for participants domain.
 */
