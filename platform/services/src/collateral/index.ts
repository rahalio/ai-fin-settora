/**
 * Collateral Services - Application Layer Export
 *
...
/**
 * Collateral Services - Application Layer
 *
 * DDD: Application use cases, ports, DTOs, policies, and errors for collateral domain.
 */
