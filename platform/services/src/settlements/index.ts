/**
 * Settlements Services - Application Layer Export
 *
...
/**
 * Settlements Services - Application Layer
 *
 * DDD: Application use cases, ports, DTOs, policies, and errors for settlements domain.
 */
