 ...
 * Finality Domain
 *
 * Barrel export for finality service, types, hooks, and view models.
 *
 * Architecture Rules:
...
// ============================================================================
export { finalityService } from './finality.service';

// ============================================================================
// Facade (high-level API for components)
// ============================================================================
export { finalityFacade } from './facade';
...
// API Types (re-exports from @settora/core only)
// ============================================================================
export type * from './finality.api-types';
